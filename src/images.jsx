...
export const isolationImages = [
  {
    location: "Reynisfjara Beach, Iceland",
    caption: "",
    url: getURL("isolation/ocean.JPG"),
  },
  {
    location: "Dandenong Ranges, Australia",
    caption: "",
    url: getURL("isolation/road.JPG"),
  },
  {
    location: "Dandenong Ranges, Australia",
    caption: "",
    url: getURL("isolation/treesky.JPG"),
  },
  {
    location: "Westfjords, Iceland",
    caption: "",
    url: getURL("isolation/farm.JPG"),
  },
  {
    location: "Dandenong Ranges, Australia",
    caption: "",
    url: getURL("isolation/dalesup.JPG"),
  },
  {
    location: "Reykjavik, Iceland",
    caption: "",
    url: getURL("isolation/across1.JPG"),
  },
  {
    location: "Reykjavik, Iceland",
    caption: "",
    url: getURL("isolation/across2.JPG"),
  },
  {
    location: "Lockdown",
    caption: "",
    url: getURL("isolation/across3.JPG"),
  },
];
